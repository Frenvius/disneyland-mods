...
## MANUAL INTERVENTION REQUIRED! (Server Admins)

Valheim changed their folder structure of world/save files and moved the world files to the new place. 
Due to this you need to:
